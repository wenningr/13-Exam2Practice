...
def run_test_practice_problem2a():
    ...
    #Test 1
    print('Expected: ', [6, 12, 9, -3, 2])
    print('Actual: ', practice_problem2a([0, 6, 3, -9, -4], 6))

    # Test 2
    print('Expected: ', [0, 2, 3, 6])
    print('Actual: ', practice_problem2a([-1, 1, 2, 5], 1))

    # Test 3
    print('Expected: ', [-6, 0, -15, -10, -4])
    print('Actual: ', practice_problem2a([0, 6, -9, -4, 2], -6))

    # Test 4
    print('Expected: ', [-2, 4, -11, -6, 0])
    print('Actual: ', practice_problem2a([0, 6, -9, -4, 2], -2))
